...
static const struct tegra_emc_table TF200X_Elpida_1GB_EDJ2108EDBG_667MHZ[] ={
	{
		0x31,       /* Rev 3.1 */
		25500,      /* SDRAM frequency */
		{
	...
	},
	{
		...
		667000,     /* SDRAM frequency */
		{
			...
			0x00000000, /* EMC_DLI_TRIM_TXDQS6 */
			0x00000000, /* EMC_DLI_TRIM_TXDQS7 */
			0x00028008, /* EMC_DLL_XFORM_DQ0 */
			0x00028008, /* EMC_DLL_XFORM_DQ1 */
			0x00028008, /* EMC_DLL_XFORM_DQ2 */
			0x00028008, /* EMC_DLL_XFORM_DQ3 */
			0x000002a0, /* EMC_XM2CMDPADCTRL */
			0x0900013d, /* EMC_XM2DQSPADCTRL2 */
			0x22220000, /* EMC_XM2DQPADCTRL2 */
			0x77fff884, /* EMC_XM2CLKPADCTRL */
...
static const struct tegra_emc_table TF200X_Hynix_1GB_667MHZ[] ={
	{
		0x31,       /* Rev 3.1 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF200XG_Elpida_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table TF200XG_Hynix_1GB_667MHZ[] ={
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
int cardhu_emc_init(void)
{
	...
	case BOARD_E1257:
		if (MEMORY_TYPE(board.sku) == SKU_MEMORY_ELPIDA)
			...
			if(!strcmp(tegra3_get_project_name(), "TF200X"))
			{
				if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
				{
					printk("BOARD_PM269:TF200X_Elpida_1GB_EDJ2108EDBG_667MHZ\n");
					tegra_init_emc(TF200X_Elpida_1GB_EDJ2108EDBG_667MHZ,
						ARRAY_SIZE(TF200X_Elpida_1GB_EDJ2108EDBG_667MHZ));
				}
				else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
				{
					printk("BOARD_PM269:TF200X_Hynix_1GB_667MHZ\n");
					tegra_init_emc(TF200X_Hynix_1GB_667MHZ,
						ARRAY_SIZE(TF200X_Hynix_1GB_667MHZ));
				}
			}
			else if(!strcmp(tegra3_get_project_name(), "TF200XG"))
			{
				if((mem_bootstrap_ad4==0)  && (mem_bootstrap_ad5==0) )
				{
					printk("BOARD_PM269:TF200XG_Elpida_1GB_667MHZ\n");
					tegra_init_emc(TF200XG_Elpida_1GB_667MHZ,
						ARRAY_SIZE(TF200XG_Elpida_1GB_667MHZ));
				}
				else if((mem_bootstrap_ad4==1)  && (mem_bootstrap_ad5==0) )
				{
					printk("BOARD_PM269:TF200XG_Hynix_1GB_667MHZ\n");
					tegra_init_emc(TF200XG_Hynix_1GB_667MHZ,
						ARRAY_SIZE(TF200XG_Hynix_1GB_667MHZ));
				}
			}
			else
			{
